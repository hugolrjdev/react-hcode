...
export const Home = () => {
  return (
    <a href="#" className="sideFlex iconMenu">
      <svg
        role="img"
        height="24"
        width="24"
        class="Svg-ytk21e-0 jAKAlG home-active-icon"
        viewBox="0 0 24 24"
      >
...
export const CreatePlayList = () => {
  return (
    <button className="sideFlex iconMenu">
      <svg
        role="img"
        height="12"
        width="12"
